...
public abstract class GraficaSwingTiempoAuto extends GraficaSwingTiempo
{
    ...
    public GraficaSwingTiempoAuto(String nombre, Skeleton padre, List<CategoriaGrafica> categorias, String nombreAbcisas, Duration duracion)
    {
        this(nombre, padre, categorias,nombreAbcisas,"dd/MM/yy HH:mm",duracion);
    } 

    public GraficaSwingTiempoAuto(String nombre, Skeleton padre, List<CategoriaGrafica> categorias, String nombreAbcisas, String formatoFecha, Duration duracion)
    {
