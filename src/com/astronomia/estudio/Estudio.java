...
import com.Global;
import com.PlantillaTarea;
import static com.astronomia.estudio.ProbabilidadCasualidad.BERNOULLI;
import static com.astronomia.estudio.ProbabilidadCasualidad.ROSENFELDT;
import com.grafica.CategoriaGrafica;
import com.grafica.GraficaSwing;
...
public class Estudio extends VBox
{
    ...
    public final InfoFuncionDensidad inputInfoFuncionDensidad() throws Excepcion, CancelExcepcion
    {
        ...
        ModalDialog dialogo = new ModalDialog(padre.esqueleto, gridPane, true);
        if (dialogo.ShowModal())
        {
            ...
            {
                new MessageDialog(padre.esqueleto, "Formato de parámetros incorrecto", MessageDialog.TipoMensaje.ERROR).Show();
                return null;
            }
        }
        else
    ...
    public void Exportar()
    {
        ...
        try
        {
            w = padre.esqueleto.getScene().getWindow();
        }
    ...
    public void Carga(String dirTrabajo) throws JDOMException, IOException, Excepcion
    {
        parseXML(new File(dirTrabajo + nombre + ".awb"));
        cambio = false;
    }

    public void Carga() throws JDOMException, IOException, Excepcion
    {
    ...
    public void parseXML(File fichero) throws JDOMException, IOException, Excepcion
    {
    ...
    public static void main(String args[])
    {
        ...
        catch (Excepcion | IOException | NullPointerException | JDOMException ex)
        {
    ...
    private void ProbabilidadAlineamientosCasuales(ProbabilidadCasualidad pc)
    {
        ...
        new MessageDialog(padre.esqueleto, String.format("Probabilidad de alineamientos astronómicos casuales %.2f%%", v * 100), MessageDialog.TipoMensaje.INFO).Show();
    ...
    private void FuncionDensidadProbabilidad()
    {
        ...
        try
        {
            ...
            GraficaSwing grafica = new GraficaSwing("", padre.esqueleto, categorias, "DE");

            InfoFuncionDensidad ifd = inputInfoFuncionDensidad();

            (new PlantillaTarea<Double>(padre.esqueleto, "", ifd.getDeclinacionMinima(), ifd.getDeclinacionMaxima(), ifd.getPasoDeclinacion())
            {

                @Override
                public void cloneActual(Double entrada)
                {
                    setActual(new Double(entrada));
                }
                ...
                {
                    setActual(getActual() + incremento);
                }

                @Override
                public int compara(Double objeto, Double referencia)
                {
                ...
                public void ciclo()
                {
                    ParFncDensidadDeclinacion par = new ParFncDensidadDeclinacion(getActual());
        ...
        catch (Excepcion | CancelExcepcion ex)
        {
