    ...
    public static Estrella getEstrella(enumEstrella estrella) throws Excepcion
    {
        ...
        switch (estrella)
        {
            case ALPHA_CRUCIS:
                ...
                mp = new Ecuatorial(new Grados(-14.86 / 3600000), new Hora(-35.83 / (3600000*15)));
            ...
            case BETA_CRUCIS:
                ...
                mp = new Ecuatorial(new Grados(-16.185 / 3600000), new Hora(-42.97 / (3600000*15)));
            ...
            case DELTA_CRUCIS:
                ...
                mp = new Ecuatorial(new Grados(-10.36 / 3600000), new Hora(-35.81 / (3600000*15)));
            ...
            case GAMMA_CRUCIS:
                ...
                mp = new Ecuatorial(new Grados(-265.08 / 3600000), new Hora(-28.23 / (3600000*15)));
            ...
            case ALPHA_CENTAURI:
                ...
                mp = new Ecuatorial(new Grados(699 / 3600000), new Hora(-3642 / (3600000*15)));
            ...
            case BETA_CENTAURI:
                ...
                mp = new Ecuatorial(new Grados(-23.16 / 3600000), new Hora(-33.27 / (3600000*15)));
            ...
            case ETA_URSAE_MAJORIS:
                ...
                mp = new Ecuatorial(new Grados(14.91 / 3600000), new Hora(121.17 / (3600000*15)));
            ...
            case ALPHA_BOOTIS:
                ...
                mp = new Ecuatorial(new Grados(-1999.4 / 3600000), new Hora(-1093.45 / (3600000*15)));
            ...
            case EPSILON_ORIONIS:
                ...
                mp = new Ecuatorial(new Grados(-1.06 / 3600000), new Hora(1.49 / (3600000*15)));
            ...
            case PLEYADES:
                ...
                mp = new Ecuatorial(new Grados(0 / 3600000), new Hora(0 / (3600000*15)));
            ...
            case ETA_TAURI:
                ...
                mp = new Ecuatorial(new Grados(-43.67 / 3600000), new Hora(19.34 / (3600000*15)));
            ...
            case ALPHA_TAURI:
                ...
                mp = new Ecuatorial(new Grados(-189.35 / 3600000), new Hora(62.78 / (3600000*15)));
            ...
            case ALPHA_CANIS_MAJORIS:
                ...
                mp = new Ecuatorial(new Grados(-1223.14 / 3600000), new Hora(-546.05 / (3600000*15)));
            ...
            case ALPHA_VIRGINIS:
                ...
                mp = new Ecuatorial(new Grados(-30.65 / 3600000), new Hora(-42.35 / (3600000*15)));
            ...
            case ALPHA_PISCIS_AUSTRINI:
                ...
                mp = new Ecuatorial(new Grados(-158.98 / 3600000), new Hora(-331.11 / (3600000*15)));
            ...
            case ALPHA_SCORPII:
                ...
                mp = new Ecuatorial(new Grados(-23.30 / 3600000), new Hora(-12.11 / (3600000*15)));
                return new Estrella(estrella.toString(), coord, mp, DiaJuliano.valueOf("1/1/2000"), 1.16);
            case ALPHA_CANIS_MINORIS:
                coord = new Ecuatorial(Grados.valueOf("5º13'29.9552''"), Hora.valueOf("7:39:18.11950"));
                mp = new Ecuatorial(new Grados(-1036.8 / 3600000), new Hora(-714.590 / (3600000*15)));
            ...
            case ALPHA_ORIONIS:
                ...
                mp = new Ecuatorial(new Grados(9.56 / 3600000), new Hora(24.95 / (3600000*15)));
            ...
            case ALPHA_AURIGAE:
                ...
                mp = new Ecuatorial(new Grados(-427.11 / 3600000), new Hora(75.52 / (3600000*15)));
            ...
            case ALPHA_CYGNI:
                ...
                mp = new Ecuatorial(new Grados(1.95 / 3600000), new Hora(1.99 / (3600000*15)));
                return new Estrella(estrella.toString(), coord, mp, DiaJuliano.valueOf("1/1/2000"), 1.25);        
            case ALPHA_LYRAE:
                coord = new Ecuatorial(Grados.valueOf("38º47'01.2802''"), Hora.valueOf("18:36:56.33635"));
                mp = new Ecuatorial(new Grados(286.23 / 3600000), new Hora(200.94 / (3600000*15)));
            ...
            case ALPHA_AQUILAE:
                ...
                mp = new Ecuatorial(new Grados(385.29 / 3600000), new Hora(536.23 / (3600000*15)));
                return new Estrella(estrella.toString(), coord, mp, DiaJuliano.valueOf("1/1/2000"), 0.77);
            case ALPHA_GEMINORUM:
                coord = new Ecuatorial(Grados.valueOf("31º53'17.8160''"), Hora.valueOf("07:34:35.87319"));
                mp = new Ecuatorial(new Grados(-145.19 / 3600000), new Hora(-191.45 / (3600000*15)));
            ...
            case BETA_GEMINORUM:
                ...
                mp = new Ecuatorial(new Grados(-45.8 / 3600000), new Hora(-626.55 / (3600000*15)));
