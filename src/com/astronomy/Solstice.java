...
public class Solstice
{
    ...
    public Solstice(int year) throws ProcessException
    {
        ...
        do
        {
            ...
            double f = Sun.getApparentPosition(new JulianDay(p), CalculusType.PRECISE).getDeclination().getSignedValue();
            if (f > 0)
            {
            ...
            double fplus = Sun.getApparentPosition(new JulianDay(pplus), CalculusType.PRECISE).getDeclination().getSignedValue();
            double fminus = Sun.getApparentPosition(new JulianDay(pminus), CalculusType.PRECISE).getDeclination().getSignedValue();
