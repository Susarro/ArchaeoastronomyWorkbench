...
public class Sun
{
     ...
     * @throws ProcessException Format error 
     */
    public static Ecliptic getPosicionEclipticaAparente(JulianDay julianDay) throws ProcessException
    {
        double T = julianDay.getCenturiesSince2000();
     ...
     * @throws ProcessException Format error
     */
    public static Equatorial getApparentPosition(JulianDay julianDay, CalculusType option) throws ProcessException
    {
        double T = julianDay.getCenturiesSince2000();
        ...
        {
            return getPosicionEclipticaAparente(julianDay).toEquatorial(julianDay.getTrueObliquityEcliptic(CalculusType.PRECISE));
        }
    }
