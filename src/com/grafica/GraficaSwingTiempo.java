...
public class GraficaSwingTiempo extends GraficaSwing
{
    ...
    public GraficaSwingTiempo(String nombre, Esqueleto padre, List<CategoriaGrafica> categorias, String nombreAbcisa, String strFormatoFecha)
    {
    ...
    public GraficaSwingTiempo(String nombre, Esqueleto padre, List<CategoriaGrafica> categorias, String nombreAbcisa)
    {
