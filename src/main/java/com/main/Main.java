...
public class Main extends Application
{
    ...
    public void start(Stage primaryStage) throws ProcessException
    {
        ...
        scene.getStylesheets().add(Skeleton.class.getResource("/styles/general.css").toExternalForm());
        ...
        mi.setOnAction((ActionEvent t)
                -> 
                {
                    ...
                    String urlHelp = getClass().getResource("/html/help.html").toExternalForm();
