...
public class Skeleton
{
    ...
    public Skeleton(String workDir, String name, Stage st, Scene sc)
    {
        ...
        try
        {
            try (InputStream configStream = Skeleton.class.getResourceAsStream("/conf/log.properties"))
            {
        ...
        {
            PropertyConfigurator.configure(Skeleton.class.getResource("/conf/log.properties"));
        }
    }        
