 ...
 * 
 * <b>Important Note:</b>
 * This is modified version of <code>DailyRollingFileAppender</code>. I have
 * just added <code>maxBackupIndex</code>. So, if your number of log files
 * increased more than <code>maxBackupIndex</code> it will delete the older log
 * files. The modified code only tested on Windows Operating System. If it have
 * any issue on any other platform please modified it accordingly.
 * 
 */
public class CustomDailyRollingFileAppender extends FileAppender
{
     ...
     * file will be truncated when it reaches
     * <code>MaxFileSize</code>.
     * @param maxBackups Max backups
     */
